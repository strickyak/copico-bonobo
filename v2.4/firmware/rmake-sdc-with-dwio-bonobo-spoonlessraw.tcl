...
set SMALL_CMDS_LEVEL1 {
    dir mdir procs list dump sleep copy del makdir deldir date cputype free
}
...
\t\$(OS9_TOOL) format -t'$params(p-tracks)' -n'$name' $name
...
Platform sdc-with-dwio-bonobo-spoonlessraw {
  Level level1 {
    Machine coco1
    set ::OsLevel 1
    set ::DefsDir "\$(N9)/defs"
    ...
    Create_track35_style_primary_boot "spoonlessraw-level1.t35" {
        rel krn krnp2 init
        boot_sdc
not working ......
        # boot_1773_30ms=boot_1773,DNum=0,STEP=3
    }
    Create_os9boot_style_secondary_boot "spoonlessraw-level1.o9b" {
        ioman clock_60=clock,PwrLnFrq=60 clock2_soft
        # scf sc6850  term_FF06=term_sc6850,HwBASE=0xFF06,Pauses=0
not working ......
        scf vtio covdg term_vdg
        rbf  rbsuper llcocosdc sd0_cocosdc=superdesc,ITDRV=0 sd1_cocosdc=superdesc,ITDRV=1
             rb1773 d0_40d=rb1773desc,DNUM=0 d1_40d=rb1773desc,DNUM=1 d2_40d=rb1773desc,DNUM=2
not working ......
        # ddsd0_cocosdc=superdesc,DD=1
        ddd0_40d=rb1773desc,DNum=0,DD=1
        pipeman piper pipe
        sysgo_dd=sysgo,dd=1
        shell_21
    }
    Create_hard_disk "spoonlessraw-level1.dsk" {
        -sectors 99999
        -track35 "spoonlessraw-level1.t35"
        -os9boot "spoonlessraw-level1.o9b"
        -cmds {@DEFAULT_CMDS_LEVEL1 @BASIC09_CMDS_LEVEL1 @LINKED_CMDS_LEVEL1}
        -sys @DEFAULT_SYS_LEVEL1
        -startup "/dev/null"
    }
    Create_40d "spoonlessraw-level1.flp" {
        -tracks 40
        -track35 "spoonlessraw-level1.t35"
        -os9boot "spoonlessraw-level1.o9b"
        -cmds {@SMALL_CMDS_LEVEL1}
        -sys @DEFAULT_SYS_LEVEL1
        -startup "/dev/null"
    }
  }
  if 0 { Level level2 {
    ...
    Create_track35_style_primary_boot "spoonlessraw-level2.t35" {
        rel_80=rel,Width=80
        boot_emu_h2=boot_emu,DISKNUM=2
        krn
    }
    Create_os9boot_style_secondary_boot "spoonlessraw-level2.o9b" {
    ...
    Create_hard_disk "spoonlessraw-level2.dsk" {
        -sectors 99999
        -track35 "spoonlessraw-level2.t35"
        -os9boot "spoonlessraw-level2.o9b"
