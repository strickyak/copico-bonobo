 ...
 * .program fire_on_rise_of_E to use the irq instead of foreground.
 * Maybe I'm calling stuff in foreground that IRQs cannot call?
 */
...
#define PUSH(N)     cross.push(N)
#define POP()       cross_pop()

#define XXX_PUSH multicore_fifo_push_blocking
#define XXX_POP  multicore_fifo_pop_blocking
